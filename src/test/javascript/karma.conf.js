...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/get-size/get-size.js',
            'src/main/webapp/bower_components/ev-emitter/ev-emitter.js',
            'src/main/webapp/bower_components/desandro-matches-selector/matches-selector.js',
            ...
            'src/main/webapp/bower_components/fizzy-ui-utils/utils.js',
            'src/main/webapp/bower_components/angular-mocks/angular-mocks.js',
            'src/main/webapp/bower_components/outlayer/outlayer.js',
            'src/main/webapp/bower_components/masonry/masonry.js',
            'src/main/webapp/bower_components/angular-masonry/angular-masonry.js',
            // endbower
